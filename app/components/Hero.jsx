          ...
          {!apiKey ? (
            <div className="flex flex-col lg:flex-row items-center gap-4 w-full lg:w-auto">
              ...
              <AuthButton
                ...
                className="bg-blue-600 text-white px-6 py-4 rounded-xl font-bold hover:bg-blue-700 transition shadow-xl shadow-blue-600/20 text-base md:text-lg w-full lg:w-auto"
              />
